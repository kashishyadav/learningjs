...
so we’ll need to provide the logic for either case. We can pass both an onFulfilled and onRejected callback to .then().
...
if the promise resolves, and the second will be invoked with 'Ohhh noooo!' if the promise rejects.
